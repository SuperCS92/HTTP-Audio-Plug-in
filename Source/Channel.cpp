...
//==============================================================================
Channel::Channel(AufgabeAudioProcessor& p): processor (p)
{
...
Channel::Channel(AufgabeAudioProcessor& p,String labelNameText, String levelDisplayName, String levelDisplayValue, String LedName,String LedToolTip):
...
void Channel::buttonClicked(Button * button)
{
    if (button == &Led_)
    {
        processor.sendChanger(label_.getText());
