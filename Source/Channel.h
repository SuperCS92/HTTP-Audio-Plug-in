...
{
public:
    Channel(AufgabeAudioProcessor&);
    Channel(AufgabeAudioProcessor& ,String labelNameText, String levelDisplayName = "LevelDisplay", String levelDisplayValue = "0.0", String LedName = " ", String LedToolTip = "Click to send this channel information");
    ~Channel();
